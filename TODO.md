...
## RECURRING ISSUE: Reddit RSS 403 Errors (2026-04-04 through 2026-05-09)
**What:** fetch step consistently returns HTTP 403 from Reddit RSS feed
**Root cause:** This environment's IP is blocked by Reddit. Both reddit.com and old.reddit.com return 403.
**Status:** Ongoing — pipeline continues without new deals, existing deals are verified each run
**Action needed:** Consider using Reddit OAuth API with credentials, or a proxy/VPN for fetching